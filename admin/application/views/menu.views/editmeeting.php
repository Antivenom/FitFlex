...
<?php
$attributes = array("name" => "editmeetingform");
echo form_open("menu/editmeeting/". $newData->id, $attributes);
?>
...
<?php echo $this->session->flashdata('verify_msg'); ?>
    ...
    <div id="new-training" class="card">
        <div class="card-header">
            <h2>Themabijeenkomst bewerken
                <small>Hier kunt u de geselecteerde Themabijeenkomst bewerken.</small>
            </h2>
        </div>
