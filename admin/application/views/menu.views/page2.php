<?php echo form_open("menu/newmeeting", array("name" => "meeting", "class" => "jsform")); ?>

<div id="error-field" class="alert alert-danger text-center hide"></div>

<div id="new-meeting" class="card">
    <div class="card-header">
        <h2>Themabijeenkomst aanmaken
            <small>Hier kunt u een themabijeenkomst aanmaken om hem vervolgens in de tabel in het overzicht te weergeven.</small>
        </h2>
    </div>
