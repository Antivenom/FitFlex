...
<head>
	...
	<link rel="icon" sizes="192x192" href="<?php echo BASE_HREF; ?>public/images/nice-highres.png">
	...
	<body>
		<?php
			if(isset($this->session->userdata['logged_in']))
			{
				...
				{
					$this->load->view('/layouts/nav/navbar.php');
				}
		...
		<div id="content-wrapper" class="container-fluid">
			<div id="sidebar-nav" class="col-md-3">
				<a id="homeBtn" class="btn btn-primary btn-sm hec-button" >Terug naar het menu</a>
